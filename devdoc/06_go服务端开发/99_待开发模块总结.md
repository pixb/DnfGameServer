...
#### 3. PK 系统
- **Java Controller**: `src/main/java/com/dnfm/game/pk/PkController.java`
- **功能**:
  - PK 请求
  - PK 战斗
  - PK 结算
...
#### 4. 成就系统
- **Java Controller**: `src/main/java/com/dnfm/game/achievement/AchievementController.java`
- **功能**:
  - 成就列表
  - 成就进度
  - 成就奖励
