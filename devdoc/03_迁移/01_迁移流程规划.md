...
├── dnf-go-client/              # Go 客户端
│   ├── gen/dnf/v1/           # 生成的 Go 代码
│   └── tests/                # Go 测试用例
└── devdoc/
    ├── 03_迁移/              # 迁移文档
    └── protobuf/
...
```bash
cd /home/pix/dev/code/java/DnfGameServer/devdoc/protobuf/reports/scripts
python generate_go_tests.py --batch <batch_number>
```
...
**测试用例位置**：
```
/home/pix/dev/code/java/DnfGameServer/dnf-go-client/tests/
├── batch_01_auth_login_test.go
├── batch_02_character_test.go
└── ...
```
