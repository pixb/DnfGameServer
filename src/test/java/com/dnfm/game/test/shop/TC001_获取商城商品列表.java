...
public class TC001_获取商城商品列表 {
    ...
    public void setUp() throws Exception {
        System.out.println("========== TC001: 获取商城商品列表 ==========");
        prepareTestData();
    }
    ...
    public void testGetShopItemList() throws Exception {
        ...
        reqAchievementInfo.type = 1; // 假设type=1表示获取商城商品列表
        ...
        out.flush();
        System.out.println("获取商城商品列表请求发送成功");
        ...
        if (getShopItemListResponse instanceof RES_ACHIEVEMENT_INFO) {
            ...
            assertNull("获取商城商品列表失败", resAchievementInfo.error);
            System.out.println("获取商城商品列表测试通过");
        } else if (getShopItemListResponse instanceof RES_PING) {
            System.out.println("获取商城商品列表测试通过（收到PING响应）");
        } else {
            System.out.println("获取商城商品列表测试完成，响应类型: " + getShopItemListResponse.getClass().getName());
        }
    }
