...
public class TC003_获取商城商品详情 {

    private static final String SERVER_IP = "127.0.0.1";
    private static final int SERVER_PORT = 10001;
    private static final String TEST_OPENID = "test_openid_shop_003";
    private static final String TEST_ROLE_GUID = "role_guid_shop_003";
    ...
    public void setUp() throws Exception {
        System.out.println("========== TC003: 获取商城商品详情 ==========");
        prepareTestData();
    }
    ...
    @Test
    public void testGetShopItemDetail() throws Exception {
        // 步骤1: 建立TCP连接
        System.out.println("\n步骤1: 建立TCP连接");
        ...
        reqLogin.type = 1;
        reqLogin.token = "test_token_shop_003";
        reqLogin.platID = 1;
        ...
        reqAchievementInfo.type = 3; // 假设type=3表示获取商城商品详情
        System.out.println("REQ_ACHIEVEMENT_INFO对象创建成功");

        // 步骤8: 编码获取商城商品详情请求
        System.out.println("\n步骤8: 编码获取商城商品详情请求");
        byte[] getShopItemDetailData = MessageCodec.encodeMessage(reqAchievementInfo, (byte) 2);
        System.out.println("编码成功，数据长度: " + getShopItemDetailData.length);

        // 步骤9: 发送获取商城商品详情请求
        System.out.println("\n步骤9: 发送获取商城商品详情请求");
        out.write(getShopItemDetailData);
        out.flush();
        System.out.println("获取商城商品详情请求发送成功");

        // 步骤10: 接收获取商城商品详情响应
        System.out.println("\n步骤10: 接收获取商城商品详情响应");
        byte[] getShopItemDetailResponseData = readMessage(in);
        Message getShopItemDetailResponse = MessageCodec.decodeMessage(getShopItemDetailResponseData);
        System.out.println("收到响应类型: " + getShopItemDetailResponse.getClass().getName());

        // 步骤11: 验证获取商城商品详情响应
        System.out.println("\n步骤11: 验证获取商城商品详情响应");
        if (getShopItemDetailResponse instanceof RES_ACHIEVEMENT_INFO) {
            RES_ACHIEVEMENT_INFO resAchievementInfo = (RES_ACHIEVEMENT_INFO) getShopItemDetailResponse;
            ...
            assertNull("获取商城商品详情失败", resAchievementInfo.error);
            System.out.println("获取商城商品详情测试通过");
        } else if (getShopItemDetailResponse instanceof RES_PING) {
            System.out.println("获取商城商品详情测试通过（收到PING响应）");
        } else {
            System.out.println("获取商城商品详情测试完成，响应类型: " + getShopItemDetailResponse.getClass().getName());
        }
    }
