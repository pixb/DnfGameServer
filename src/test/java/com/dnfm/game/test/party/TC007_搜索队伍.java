...
public class TC007_搜索队伍 {
    ...
    public void testSearchParty() throws Exception {
        ...
        System.out.println("REQ_SEARCH_PARTY_LIST对象创建成功");
