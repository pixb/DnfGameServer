...
public class TC001_创建队伍 {
    ...
    public void testCreateParty() throws Exception {
        ...
        reqControlGroup.area = 7; // 区域
        reqControlGroup.subtype = 1; // 子类型
        reqControlGroup.stageindex = 1; // 阶段索引
        reqControlGroup.dungeonindex = 109922; // 副本索引
        reqControlGroup.minlevel = 1; // 最低等级
        reqControlGroup.maxlevel = 100; // 最高等级
        reqControlGroup.partyname = "测试队伍_001";
