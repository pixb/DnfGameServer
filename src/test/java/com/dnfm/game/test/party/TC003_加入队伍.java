...
public class TC003_加入队伍 {
    ...
    public void testJoinParty() throws Exception {
        ...
        reqControlGroup.partyguid = 39466795435429301L; // 队伍GUID
