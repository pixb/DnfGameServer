...
public class TC011_队伍副本_开始多人游戏 {

    private static final String SERVER_HOST = "127.0.0.1";
    private static final int SERVER_PORT = 10001;
    private static final int CONNECT_TIMEOUT = 10000;
    private static final String TEST_OPENID = "test_openid_011";
    ...
    public void setUp() throws Exception {
        System.out.println("========== TC011: 队伍副本_开始多人游戏 ==========");
        prepareTestData();
    }
    ...
    @Test
    public void testStartMultiPlay() throws Exception {
        System.out.println("\n步骤1: 建立TCP连接");
        ...
        out.write(reqData);
        out.flush();
        System.out.println("开始多人游戏请求发送成功");
        ...
        while (!responseReceived && System.currentTimeMillis() - startTime < timeout) {
            try {
                byte[] multiPlayResponseBytes = readMessage(in);
                Object msg = MessageCodec.decodeMessage(multiPlayResponseBytes);
