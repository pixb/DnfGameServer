...
public class TC010_队伍成员管理_踢出队员 {
    ...
    public void setUp() throws Exception {
        System.out.println("========== TC010: 队伍成员管理_踢出队员 ==========");
        prepareTestData();
    }
    ...
    public void testKickMember() throws Exception {
        ...
        reqControlGroup.type = 17; // 踢出队员类型
        reqControlGroup.targetguid = 123456L; // 队员ID
        ...
        while (!responseReceived && System.currentTimeMillis() - startTime < timeout) {
            try {
                byte[] kickResponseBytes = readMessage(in);
                Object msg = MessageCodec.decodeMessage(kickResponseBytes);
