...
public class TC009_队伍设置_修改设置 {
    ...
    public void setUp() throws Exception {
        System.out.println("========== TC009: 队伍设置_修改设置 ==========");
        prepareTestData();
    }
    ...
    @Test
    public void testModifyPartySettings() throws Exception {
        System.out.println("\n步骤1: 建立TCP连接");
        ...
        reqControlGroup.type = 16; // 修改队伍设置类型
        reqControlGroup.minlevel = 1;
        reqControlGroup.maxlevel = 100;
        ...
        out.write(reqData);
        out.flush();
        System.out.println("修改队伍设置请求发送成功");
        ...
        while (!responseReceived && System.currentTimeMillis() - startTime < timeout) {
            try {
                byte[] modifyResponseBytes = readMessage(in);
                Object msg = MessageCodec.decodeMessage(modifyResponseBytes);
