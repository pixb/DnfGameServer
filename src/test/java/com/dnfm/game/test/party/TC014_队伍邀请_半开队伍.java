...
public class TC014_队伍邀请_半开队伍 {

    private static final String SERVER_HOST = "127.0.0.1";
    private static final int SERVER_PORT = 10001;
    private static final int CONNECT_TIMEOUT = 10000;
    private static final String TEST_OPENID = "test_openid_014";
    ...
    public void setUp() throws Exception {
        System.out.println("========== TC014: 队伍邀请_半开队伍 ==========");
        prepareTestData();
    }
    ...
    public void tearDown() throws Exception {
        ...
        cleanTestData();
        System.out.println("========== TC014 测试结束 ==========");
    }

    @Test
    public void testPartyInviteHalfOpen() throws Exception {
        System.out.println("\n步骤1: 建立TCP连接");
        ...
        reqControlGroup.type = 19; // 半开队伍类型
        reqControlGroup.targetguid = 123456L; // 目标ID
        ...
        out.write(reqData);
        out.flush();
        System.out.println("半开队伍邀请请求发送成功");
        ...
        while (!responseReceived && System.currentTimeMillis() - startTime < timeout) {
            try {
                byte[] inviteResponseBytes = readMessage(in);
                Object msg = MessageCodec.decodeMessage(inviteResponseBytes);
