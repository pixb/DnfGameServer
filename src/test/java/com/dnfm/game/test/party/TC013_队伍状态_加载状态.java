...
public class TC013_队伍状态_加载状态 {

    private static final String SERVER_HOST = "127.0.0.1";
    private static final int SERVER_PORT = 10001;
    private static final int CONNECT_TIMEOUT = 10000;
    private static final String TEST_OPENID = "test_openid_013";
    ...
    public void setUp() throws Exception {
        System.out.println("========== TC013: 队伍状态_加载状态 ==========");
        prepareTestData();
    }
    ...
    public void tearDown() throws Exception {
        ...
        cleanTestData();
        System.out.println("========== TC013 测试结束 ==========");
    }

    @Test
    public void testPartyLoadingStatus() throws Exception {
        System.out.println("\n步骤1: 建立TCP连接");
        ...
        reqControlGroup.type = 18; // 队伍加载状态类型
        ...
        out.write(reqData);
        out.flush();
        System.out.println("队伍加载状态请求发送成功");
        ...
        while (!responseReceived && System.currentTimeMillis() - startTime < timeout) {
            try {
                byte[] loadingResponseBytes = readMessage(in);
                Object msg = MessageCodec.decodeMessage(loadingResponseBytes);
