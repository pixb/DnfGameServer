...
public class TC005_返回城镇_多人游戏 {

    private static final String SERVER_HOST = "127.0.0.1";
    private static final int SERVER_PORT = 10001;
    private static final int CONNECT_TIMEOUT = 10000;
    private static final String TEST_OPENID = "test_openid_pk_005";
    ...
    public void setUp() throws Exception {
        System.out.println("========== TC005: 返回城镇（多人游戏） ==========");
        prepareTestData();
    }
    ...
    @Test
    public void testReturnToTown() throws Exception {
        System.out.println("\n步骤1: 建立TCP连接");
        ...
        reqLogin.type = 1;
        reqLogin.token = "test_token_pk_005";
        reqLogin.platID = 1;
        ...
        System.out.println("\n步骤8: 构造返回城镇请求");
        REQ_RETURN_TO_TOWN_AT_MULTI_PLAY reqReturnToTown = new REQ_RETURN_TO_TOWN_AT_MULTI_PLAY();
        System.out.println("REQ_RETURN_TO_TOWN_AT_MULTI_PLAY对象创建成功");

        System.out.println("\n步骤9: 编码返回城镇请求");
        byte[] returnToTownEncodedMessage = MessageCodec.encodeMessage(reqReturnToTown, (byte) (seq + 1));
        assertNotNull("编码失败", returnToTownEncodedMessage);
        assertTrue("编码数据为空", returnToTownEncodedMessage.length > 0);
        System.out.println("编码成功，数据长度: " + returnToTownEncodedMessage.length);

        System.out.println("\n步骤10: 发送返回城镇请求");
        out.write(returnToTownEncodedMessage);
        out.flush();
        System.out.println("返回城镇请求发送成功");
        ...
        while (!responseReceived && System.currentTimeMillis() - startTime < timeout) {
            try {
                byte[] returnToTownResponseBytes = readMessage(in);
                Object msg = MessageCodec.decodeMessage(returnToTownResponseBytes);
