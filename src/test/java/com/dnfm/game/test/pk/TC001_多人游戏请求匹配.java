...
public class TC001_多人游戏请求匹配 {

    private static final String SERVER_HOST = "127.0.0.1";
    private static final int SERVER_PORT = 10001;
    private static final int CONNECT_TIMEOUT = 10000;
    private static final String TEST_OPENID = "test_openid_pk_001";
    ...
    public void setUp() throws Exception {
        System.out.println("========== TC001: 多人游戏请求匹配 ==========");
        prepareTestData();
    }
    ...
    @Test
    public void testMultiPlayRequestMatch() throws Exception {
        System.out.println("\n步骤1: 建立TCP连接");
        ...
        reqLogin.type = 1;
        reqLogin.token = "test_token_pk_001";
        reqLogin.platID = 1;
        ...
        System.out.println("\n步骤12: 验证多人游戏请求匹配成功");
        System.out.println("多人游戏请求匹配测试通过");
    }
