...
public class TC009_多人游戏请求匹配_无效参数 {

    private static final String SERVER_HOST = "127.0.0.1";
    private static final int SERVER_PORT = 10001;
    private static final int CONNECT_TIMEOUT = 10000;
    private static final String TEST_OPENID = "test_openid_pk_009";
    ...
    public void setUp() throws Exception {
        System.out.println("========== TC009: 多人游戏请求匹配_无效参数 ==========");
        prepareTestData();
    }
    ...
    @Test
    public void testMultiPlayRequestMatchWithInvalidParams() throws Exception {
        System.out.println("\n步骤1: 建立TCP连接");
        ...
        reqLogin.type = 1;
        reqLogin.token = "test_token_pk_009";
        reqLogin.platID = 1;
        ...
        System.out.println("\n步骤8: 构造多人游戏请求匹配请求（无效参数）");
        MultiPlayRequestMatchRequest reqMatch = MultiPlayRequestMatchRequest.newBuilder()
                .setField2(-1) // 对应matchType，无效的匹配类型
                .setField3(999) // 对应dungeonIndex，无效的副本索引
                .build();
        ...
        System.out.println("\n步骤12: 验证多人游戏请求匹配响应");
        System.out.println("多人游戏请求匹配_无效参数测试通过");
    }
