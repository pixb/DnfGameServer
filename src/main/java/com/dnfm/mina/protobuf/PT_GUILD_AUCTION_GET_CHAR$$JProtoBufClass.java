...
public class PT_GUILD_AUCTION_GET_CHAR$$JProtoBufClass implements Codec<PT_GUILD_AUCTION_GET_CHAR>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_GUILD_AUCTION_GET_CHAR var1) throws IOException {
   ...
   public PT_GUILD_AUCTION_GET_CHAR decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_GUILD_AUCTION_GET_CHAR var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      if (!CodedConstant.isNull(var1.rank)) {
         Integer var10 = var1.rank;
   ...
   public void doWriteTo(PT_GUILD_AUCTION_GET_CHAR var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.rank)) {
         Integer var10 = var1.rank;
         if (var10 != null) {
   ...
   public void writeTo(PT_GUILD_AUCTION_GET_CHAR var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_GUILD_AUCTION_GET_CHAR readFrom(CodedInputStream var1) throws IOException {
      PT_GUILD_AUCTION_GET_CHAR var2 = new PT_GUILD_AUCTION_GET_CHAR();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_GUILD_AUCTION_GET_CHAR.class);
