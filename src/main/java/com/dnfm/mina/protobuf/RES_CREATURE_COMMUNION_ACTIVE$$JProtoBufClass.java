...
public class RES_CREATURE_COMMUNION_ACTIVE$$JProtoBufClass implements Codec<RES_CREATURE_COMMUNION_ACTIVE>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_CREATURE_COMMUNION_ACTIVE var1) throws IOException {
   ...
   public RES_CREATURE_COMMUNION_ACTIVE decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_CREATURE_COMMUNION_ACTIVE var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.info)) {
         PT_CREATURE_COMMUNION var7 = var1.info;
   ...
   public void doWriteTo(RES_CREATURE_COMMUNION_ACTIVE var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var6 = var1.error;
         if (var6 != null) {
   ...
   public void writeTo(RES_CREATURE_COMMUNION_ACTIVE var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_CREATURE_COMMUNION_ACTIVE readFrom(CodedInputStream var1) throws IOException {
      RES_CREATURE_COMMUNION_ACTIVE var2 = new RES_CREATURE_COMMUNION_ACTIVE();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_CREATURE_COMMUNION_ACTIVE.class);
