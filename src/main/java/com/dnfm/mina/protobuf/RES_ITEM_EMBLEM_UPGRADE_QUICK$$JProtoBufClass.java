...
public class RES_ITEM_EMBLEM_UPGRADE_QUICK$$JProtoBufClass implements Codec<RES_ITEM_EMBLEM_UPGRADE_QUICK>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_ITEM_EMBLEM_UPGRADE_QUICK var1) throws IOException {
   ...
   public RES_ITEM_EMBLEM_UPGRADE_QUICK decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_ITEM_EMBLEM_UPGRADE_QUICK var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(RES_ITEM_EMBLEM_UPGRADE_QUICK var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var8 = var1.error;
         if (var8 != null) {
   ...
   public void writeTo(RES_ITEM_EMBLEM_UPGRADE_QUICK var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_ITEM_EMBLEM_UPGRADE_QUICK readFrom(CodedInputStream var1) throws IOException {
      RES_ITEM_EMBLEM_UPGRADE_QUICK var2 = new RES_ITEM_EMBLEM_UPGRADE_QUICK();
      var2.source = new ArrayList();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               var2.target = var1.readInt32();
            } else if (var5 == 26) {
               Codec var10 = ProtobufProxy.create(PT_INDEX_COUNT.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               ...
               var2.source.add((PT_INDEX_COUNT)var10.readFrom(var1));
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_ITEM_EMBLEM_UPGRADE_QUICK.class);
