...
public class PT_ALL_CLEAR_REWARD$$JProtoBufClass implements Codec<PT_ALL_CLEAR_REWARD>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_ALL_CLEAR_REWARD var1) throws IOException {
   ...
   public PT_ALL_CLEAR_REWARD decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_ALL_CLEAR_REWARD var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.index)) {
         Integer var38 = var1.index;
         var2 += CodedOutputStream.computeInt32Size(17, var38);
      }

      Object var20 = null;
      if (!CodedConstant.isNull(var1.count)) {
         Integer var39 = var1.count;
         var2 += CodedOutputStream.computeInt32Size(18, var39);
      }

      Object var21 = null;
      if (!CodedConstant.isNull(var1.floor)) {
         Integer var40 = var1.floor;
   ...
   public void doWriteTo(PT_ALL_CLEAR_REWARD var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.equipitems)) {
         List var22 = var1.equipitems;
         if (var22 != null) {
   ...
   public void writeTo(PT_ALL_CLEAR_REWARD var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_ALL_CLEAR_REWARD readFrom(CodedInputStream var1) throws IOException {
      PT_ALL_CLEAR_REWARD var2 = new PT_ALL_CLEAR_REWARD();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_ALL_CLEAR_REWARD.class);
