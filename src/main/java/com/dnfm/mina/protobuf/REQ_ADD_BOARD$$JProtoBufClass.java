...
public class REQ_ADD_BOARD$$JProtoBufClass implements Codec<REQ_ADD_BOARD>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(REQ_ADD_BOARD var1) throws IOException {
   ...
   public REQ_ADD_BOARD decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(REQ_ADD_BOARD var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(REQ_ADD_BOARD var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.boardtype)) {
         Integer var8 = var1.boardtype;
         if (var8 != null) {
   ...
   public void writeTo(REQ_ADD_BOARD var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public REQ_ADD_BOARD readFrom(CodedInputStream var1) throws IOException {
      REQ_ADD_BOARD var2 = new REQ_ADD_BOARD();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(REQ_ADD_BOARD.class);
