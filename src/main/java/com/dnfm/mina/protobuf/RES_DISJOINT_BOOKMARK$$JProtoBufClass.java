...
public class RES_DISJOINT_BOOKMARK$$JProtoBufClass implements Codec<RES_DISJOINT_BOOKMARK>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_DISJOINT_BOOKMARK var1) throws IOException {
   ...
   public RES_DISJOINT_BOOKMARK decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_DISJOINT_BOOKMARK var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(RES_DISJOINT_BOOKMARK var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var6 = var1.error;
         if (var6 != null) {
   ...
   public void writeTo(RES_DISJOINT_BOOKMARK var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_DISJOINT_BOOKMARK readFrom(CodedInputStream var1) throws IOException {
      RES_DISJOINT_BOOKMARK var2 = new RES_DISJOINT_BOOKMARK();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_DISJOINT_BOOKMARK.class);
