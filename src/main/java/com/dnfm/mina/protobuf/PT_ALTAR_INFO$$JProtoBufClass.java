...
public class PT_ALTAR_INFO$$JProtoBufClass implements Codec<PT_ALTAR_INFO>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_ALTAR_INFO var1) throws IOException {
   ...
   public PT_ALTAR_INFO decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_ALTAR_INFO var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.blue)) {
         PT_BATTLEFIELD_TEAMINFO var16 = var1.blue;
   ...
   public void doWriteTo(PT_ALTAR_INFO var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.index)) {
         Integer var10 = var1.index;
         if (var10 != null) {
   ...
   public void writeTo(PT_ALTAR_INFO var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_ALTAR_INFO readFrom(CodedInputStream var1) throws IOException {
      PT_ALTAR_INFO var2 = new PT_ALTAR_INFO();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_ALTAR_INFO.class);
