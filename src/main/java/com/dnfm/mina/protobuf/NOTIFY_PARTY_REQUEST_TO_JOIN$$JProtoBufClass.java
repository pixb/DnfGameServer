...
public class NOTIFY_PARTY_REQUEST_TO_JOIN$$JProtoBufClass implements Codec<NOTIFY_PARTY_REQUEST_TO_JOIN>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(NOTIFY_PARTY_REQUEST_TO_JOIN var1) throws IOException {
   ...
   public NOTIFY_PARTY_REQUEST_TO_JOIN decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(NOTIFY_PARTY_REQUEST_TO_JOIN var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(NOTIFY_PARTY_REQUEST_TO_JOIN var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var16 = var1.error;
         if (var16 != null) {
   ...
   public void writeTo(NOTIFY_PARTY_REQUEST_TO_JOIN var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public NOTIFY_PARTY_REQUEST_TO_JOIN readFrom(CodedInputStream var1) throws IOException {
      NOTIFY_PARTY_REQUEST_TO_JOIN var2 = new NOTIFY_PARTY_REQUEST_TO_JOIN();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(NOTIFY_PARTY_REQUEST_TO_JOIN.class);
