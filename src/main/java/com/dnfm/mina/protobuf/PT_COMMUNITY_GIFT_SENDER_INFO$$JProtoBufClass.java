...
public class PT_COMMUNITY_GIFT_SENDER_INFO$$JProtoBufClass implements Codec<PT_COMMUNITY_GIFT_SENDER_INFO>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_COMMUNITY_GIFT_SENDER_INFO var1) throws IOException {
   ...
   public PT_COMMUNITY_GIFT_SENDER_INFO decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_COMMUNITY_GIFT_SENDER_INFO var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      if (!CodedConstant.isNull(var1.name)) {
         String var18 = var1.name;
         var2 += CodedOutputStream.computeStringSize(1, var18);
      }
      ...
      if (!CodedConstant.isNull(var1.secondgrowtype)) {
         Integer var22 = var1.secondgrowtype;
   ...
   public void doWriteTo(PT_COMMUNITY_GIFT_SENDER_INFO var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.name)) {
         String var18 = var1.name;
         if (var18 != null) {
            var2.writeString(1, var18);
         }
      }
   ...
   public void writeTo(PT_COMMUNITY_GIFT_SENDER_INFO var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_COMMUNITY_GIFT_SENDER_INFO readFrom(CodedInputStream var1) throws IOException {
      PT_COMMUNITY_GIFT_SENDER_INFO var2 = new PT_COMMUNITY_GIFT_SENDER_INFO();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_COMMUNITY_GIFT_SENDER_INFO.class);
