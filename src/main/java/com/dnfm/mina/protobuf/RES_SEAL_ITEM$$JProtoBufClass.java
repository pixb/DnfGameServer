...
public class RES_SEAL_ITEM$$JProtoBufClass implements Codec<RES_SEAL_ITEM>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_SEAL_ITEM var1) throws IOException {
   ...
   public RES_SEAL_ITEM decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_SEAL_ITEM var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.removeitems)) {
         PT_REMOVEITEMS var8 = var1.removeitems;
   ...
   public void doWriteTo(RES_SEAL_ITEM var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var6 = var1.error;
         if (var6 != null) {
   ...
   public void writeTo(RES_SEAL_ITEM var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_SEAL_ITEM readFrom(CodedInputStream var1) throws IOException {
      RES_SEAL_ITEM var2 = new RES_SEAL_ITEM();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_SEAL_ITEM.class);
