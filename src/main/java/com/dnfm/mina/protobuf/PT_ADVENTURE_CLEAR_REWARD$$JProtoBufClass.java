...
public class PT_ADVENTURE_CLEAR_REWARD$$JProtoBufClass implements Codec<PT_ADVENTURE_CLEAR_REWARD>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_ADVENTURE_CLEAR_REWARD var1) throws IOException {
   ...
   public PT_ADVENTURE_CLEAR_REWARD decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_ADVENTURE_CLEAR_REWARD var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      if (!CodedConstant.isNull(var1.exp)) {
         Integer var8 = var1.exp;
   ...
   public void doWriteTo(PT_ADVENTURE_CLEAR_REWARD var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.exp)) {
         Integer var8 = var1.exp;
         if (var8 != null) {
   ...
   public void writeTo(PT_ADVENTURE_CLEAR_REWARD var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_ADVENTURE_CLEAR_REWARD readFrom(CodedInputStream var1) throws IOException {
      PT_ADVENTURE_CLEAR_REWARD var2 = new PT_ADVENTURE_CLEAR_REWARD();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               var2.list.add((PT_MONEY_ITEM)var11.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var13);
            } else {
               var1.skipField(var5);
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_ADVENTURE_CLEAR_REWARD.class);
