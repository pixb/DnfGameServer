...
public class RES_FOLLOW_FRIEND$$JProtoBufClass implements Codec<RES_FOLLOW_FRIEND>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_FOLLOW_FRIEND var1) throws IOException {
   ...
   public RES_FOLLOW_FRIEND decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_FOLLOW_FRIEND var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(RES_FOLLOW_FRIEND var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var9 = var1.error;
         if (var9 != null) {
   ...
   public void writeTo(RES_FOLLOW_FRIEND var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_FOLLOW_FRIEND readFrom(CodedInputStream var1) throws IOException {
      RES_FOLLOW_FRIEND var2 = new RES_FOLLOW_FRIEND();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_FOLLOW_FRIEND.class);
