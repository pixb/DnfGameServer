...
public class RES_RAID_REWARD$$JProtoBufClass implements Codec<RES_RAID_REWARD>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_RAID_REWARD var1) throws IOException {
   ...
   public RES_RAID_REWARD decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_RAID_REWARD var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      Object var8 = null;
      if (!CodedConstant.isNull(var1.firstclearcount)) {
         Long var14 = var1.firstclearcount;
   ...
   public void doWriteTo(RES_RAID_REWARD var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var9 = var1.error;
         if (var9 != null) {
   ...
   public void writeTo(RES_RAID_REWARD var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_RAID_REWARD readFrom(CodedInputStream var1) throws IOException {
      RES_RAID_REWARD var2 = new RES_RAID_REWARD();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               Codec var10 = ProtobufProxy.create(PT_RAID_USER_REWARDS.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               ...
               var2.rewards.add((PT_RAID_USER_REWARDS)var10.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var7);
            } else if (var5 == 26) {
               Codec var11 = ProtobufProxy.create(PT_ITEMS.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               int var14 = var1.readRawVarint32();
               int var17 = var1.pushLimit(var14);
               var2.items = (PT_ITEMS)var11.readFrom(var1);
               var1.checkLastTagWas(0);
               var1.popLimit(var17);
            } else if (var5 == 34) {
               ...
               var2.accountcurrency.add((PT_MONEY_ITEM)var13.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var19);
            } else if (var5 == 48) {
               var2.firstclearcount = var1.readUInt64();
            } else {
               var1.skipField(var5);
            }
         }
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_RAID_REWARD.class);
