...
public class PT_ITEMS$$JProtoBufClass implements Codec<PT_ITEMS>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_ITEMS var1) throws IOException {
   ...
   public PT_ITEMS decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_ITEMS var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      if (!CodedConstant.isNull(var1.equipitems)) {
         List var25 = var1.equipitems;
         var2 += CodedConstant.computeListSize(1, var25, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var4 = null;
      if (!CodedConstant.isNull(var1.titleitems)) {
         List var26 = var1.titleitems;
      ...
      if (!CodedConstant.isNull(var1.materialitems)) {
         List var28 = var1.materialitems;
         var2 += CodedConstant.computeListSize(4, var28, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var7 = null;
      if (!CodedConstant.isNull(var1.consumeitems)) {
         List var29 = var1.consumeitems;
         var2 += CodedConstant.computeListSize(5, var29, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var8 = null;
      if (!CodedConstant.isNull(var1.emblemitems)) {
         List var30 = var1.emblemitems;
         var2 += CodedConstant.computeListSize(6, var30, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var9 = null;
      if (!CodedConstant.isNull(var1.carditems)) {
         List var31 = var1.carditems;
         var2 += CodedConstant.computeListSize(7, var31, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var10 = null;
      if (!CodedConstant.isNull(var1.epicpieceitems)) {
         List var32 = var1.epicpieceitems;
         var2 += CodedConstant.computeListSize(8, var32, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var11 = null;
      if (!CodedConstant.isNull(var1.cartifactitems)) {
         List var33 = var1.cartifactitems;
         var2 += CodedConstant.computeListSize(9, var33, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var12 = null;
      if (!CodedConstant.isNull(var1.creatureitems)) {
         List var34 = var1.creatureitems;
         var2 += CodedConstant.computeListSize(10, var34, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var13 = null;
      if (!CodedConstant.isNull(var1.avataritems)) {
         List var35 = var1.avataritems;
         var2 += CodedConstant.computeListSize(11, var35, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var14 = null;
      if (!CodedConstant.isNull(var1.damagefontitems)) {
         List var36 = var1.damagefontitems;
         var2 += CodedConstant.computeListSize(12, var36, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var15 = null;
      if (!CodedConstant.isNull(var1.chatframeitems)) {
         List var37 = var1.chatframeitems;
         var2 += CodedConstant.computeListSize(13, var37, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var16 = null;
      if (!CodedConstant.isNull(var1.characterframeitems)) {
         List var38 = var1.characterframeitems;
         var2 += CodedConstant.computeListSize(14, var38, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var17 = null;
      if (!CodedConstant.isNull(var1.crackitems)) {
         List var39 = var1.crackitems;
         var2 += CodedConstant.computeListSize(15, var39, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var18 = null;
      if (!CodedConstant.isNull(var1.crackequipitems)) {
         List var40 = var1.crackequipitems;
         var2 += CodedConstant.computeListSize(16, var40, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var19 = null;
      if (!CodedConstant.isNull(var1.sdavataritems)) {
         List var41 = var1.sdavataritems;
         var2 += CodedConstant.computeListSize(17, var41, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var20 = null;
      if (!CodedConstant.isNull(var1.timebox)) {
         List var42 = var1.timebox;
      ...
      if (!CodedConstant.isNull(var1.bookmarkitems)) {
         List var43 = var1.bookmarkitems;
         var2 += CodedConstant.computeListSize(19, var43, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var22 = null;
      if (!CodedConstant.isNull(var1.scrollitems)) {
         List var44 = var1.scrollitems;
         var2 += CodedConstant.computeListSize(20, var44, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var23 = null;
      if (!CodedConstant.isNull(var1.index)) {
         Integer var45 = var1.index;
         var2 += CodedOutputStream.computeInt32Size(21, var45);
      }

      Object var24 = null;
      if (!CodedConstant.isNull(var1.count)) {
         Integer var46 = var1.count;
   ...
   public void doWriteTo(PT_ITEMS var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.equipitems)) {
         List var25 = var1.equipitems;
         if (var25 != null) {
            CodedConstant.writeToList(var2, 1, FieldType.OBJECT, var25, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.materialitems)) {
         List var28 = var1.materialitems;
         if (var28 != null) {
            CodedConstant.writeToList(var2, 4, FieldType.OBJECT, var28, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.consumeitems)) {
         List var29 = var1.consumeitems;
         if (var29 != null) {
            CodedConstant.writeToList(var2, 5, FieldType.OBJECT, var29, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.emblemitems)) {
         List var30 = var1.emblemitems;
         if (var30 != null) {
            CodedConstant.writeToList(var2, 6, FieldType.OBJECT, var30, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.carditems)) {
         List var31 = var1.carditems;
         if (var31 != null) {
            CodedConstant.writeToList(var2, 7, FieldType.OBJECT, var31, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.epicpieceitems)) {
         List var32 = var1.epicpieceitems;
         if (var32 != null) {
            CodedConstant.writeToList(var2, 8, FieldType.OBJECT, var32, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.cartifactitems)) {
         List var33 = var1.cartifactitems;
         if (var33 != null) {
            CodedConstant.writeToList(var2, 9, FieldType.OBJECT, var33, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.creatureitems)) {
         List var34 = var1.creatureitems;
         if (var34 != null) {
            CodedConstant.writeToList(var2, 10, FieldType.OBJECT, var34, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.avataritems)) {
         List var35 = var1.avataritems;
         if (var35 != null) {
            CodedConstant.writeToList(var2, 11, FieldType.OBJECT, var35, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.damagefontitems)) {
         List var36 = var1.damagefontitems;
         if (var36 != null) {
            CodedConstant.writeToList(var2, 12, FieldType.OBJECT, var36, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.chatframeitems)) {
         List var37 = var1.chatframeitems;
         if (var37 != null) {
            CodedConstant.writeToList(var2, 13, FieldType.OBJECT, var37, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.characterframeitems)) {
         List var38 = var1.characterframeitems;
         if (var38 != null) {
            CodedConstant.writeToList(var2, 14, FieldType.OBJECT, var38, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.crackitems)) {
         List var39 = var1.crackitems;
         if (var39 != null) {
            CodedConstant.writeToList(var2, 15, FieldType.OBJECT, var39, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.crackequipitems)) {
         List var40 = var1.crackequipitems;
         if (var40 != null) {
            CodedConstant.writeToList(var2, 16, FieldType.OBJECT, var40, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.sdavataritems)) {
         List var41 = var1.sdavataritems;
         if (var41 != null) {
            CodedConstant.writeToList(var2, 17, FieldType.OBJECT, var41, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.bookmarkitems)) {
         List var43 = var1.bookmarkitems;
         if (var43 != null) {
            CodedConstant.writeToList(var2, 19, FieldType.OBJECT, var43, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.scrollitems)) {
         List var44 = var1.scrollitems;
         if (var44 != null) {
            CodedConstant.writeToList(var2, 20, FieldType.OBJECT, var44, false);
         }
      }
   ...
   public void writeTo(PT_ITEMS var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_ITEMS readFrom(CodedInputStream var1) throws IOException {
      PT_ITEMS var2 = new PT_ITEMS();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 10) {
               ...
               int var49 = var1.pushLimit(var30);
               ...
               int var50 = var1.pushLimit(var31);
               ...
               int var51 = var1.pushLimit(var32);
               ...
               int var52 = var1.pushLimit(var33);
               ...
               int var53 = var1.pushLimit(var34);
               ...
               int var54 = var1.pushLimit(var35);
               ...
               int var55 = var1.pushLimit(var36);
               ...
               int var56 = var1.pushLimit(var37);
               ...
               int var57 = var1.pushLimit(var38);
               ...
               int var58 = var1.pushLimit(var39);
               ...
               int var59 = var1.pushLimit(var40);
               ...
               int var60 = var1.pushLimit(var41);
               ...
               int var61 = var1.pushLimit(var42);
               ...
               int var62 = var1.pushLimit(var43);
               ...
               int var63 = var1.pushLimit(var44);
               if (var2.crackequipitems == null) {
                  var2.crackequipitems = new ArrayList();
               }

               var2.crackequipitems.add((PT_EQUIP)var25.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var63);
            } else if (var5 == 138) {
               ...
               int var64 = var1.pushLimit(var45);
               if (var2.sdavataritems == null) {
                  var2.sdavataritems = new ArrayList();
               }

               var2.sdavataritems.add((PT_AVATAR_ITEM)var26.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var64);
            } else if (var5 == 146) {
               Codec var27 = ProtobufProxy.create(PT_ITEM_TIMEBOX.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               int var46 = var1.readRawVarint32();
               int var65 = var1.pushLimit(var46);
               if (var2.timebox == null) {
                  var2.timebox = new ArrayList();
               }

               var2.timebox.add((PT_ITEM_TIMEBOX)var27.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var65);
            } else if (var5 == 154) {
               Codec var28 = ProtobufProxy.create(PT_STACKABLE.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               int var47 = var1.readRawVarint32();
               int var66 = var1.pushLimit(var47);
               if (var2.bookmarkitems == null) {
                  var2.bookmarkitems = new ArrayList();
               }

               var2.bookmarkitems.add((PT_STACKABLE)var28.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var66);
            } else if (var5 == 162) {
               Codec var29 = ProtobufProxy.create(PT_EQUIP.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               int var48 = var1.readRawVarint32();
               int var67 = var1.pushLimit(var48);
               if (var2.scrollitems == null) {
                  var2.scrollitems = new ArrayList();
               }

               var2.scrollitems.add((PT_EQUIP)var29.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var67);
            } else if (var5 == 168) {
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_ITEMS.class);
