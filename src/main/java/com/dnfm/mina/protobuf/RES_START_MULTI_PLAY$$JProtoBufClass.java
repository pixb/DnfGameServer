...
public class RES_START_MULTI_PLAY$$JProtoBufClass implements Codec<RES_START_MULTI_PLAY>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_START_MULTI_PLAY var1) throws IOException {
   ...
   public RES_START_MULTI_PLAY decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_START_MULTI_PLAY var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.targetguid)) {
         Long var29 = var1.targetguid;
         var2 += CodedOutputStream.computeUInt64Size(11, var29);
      }
   ...
   public void doWriteTo(RES_START_MULTI_PLAY var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var19 = var1.error;
         if (var19 != null) {
   ...
   public void writeTo(RES_START_MULTI_PLAY var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_START_MULTI_PLAY readFrom(CodedInputStream var1) throws IOException {
      RES_START_MULTI_PLAY var2 = new RES_START_MULTI_PLAY();
      var2.users = new ArrayList();
      var2.detail = new ArrayList();
      var2.pvpdiceinfo = new ArrayList();
      var2.historicsiterelics = new ArrayList();
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               if (var5 == 112) {
                  ...
                  Codec var11 = ProtobufProxy.create(PT_PVP_DICE_INFO.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
                  ...
                  var2.pvpdiceinfo.add((PT_PVP_DICE_INFO)var11.readFrom(var1));
                  var1.checkLastTagWas(0);
                  var1.popLimit(var18);
               } else if (var5 == 130) {
                  Codec var12 = ProtobufProxy.create(PT_HISTORICSITE_RELIC_INFO.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
                  int var15 = var1.readRawVarint32();
                  int var19 = var1.pushLimit(var15);
                  if (var2.historicsiterelics == null) {
                     var2.historicsiterelics = new ArrayList();
                  }

                  var2.historicsiterelics.add((PT_HISTORICSITE_RELIC_INFO)var12.readFrom(var1));
                  var1.checkLastTagWas(0);
                  var1.popLimit(var19);
               } else {
                  var1.skipField(var5);
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_START_MULTI_PLAY.class);
