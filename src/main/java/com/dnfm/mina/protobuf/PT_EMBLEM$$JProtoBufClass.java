...
public class PT_EMBLEM$$JProtoBufClass implements Codec<PT_EMBLEM>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_EMBLEM var1) throws IOException {
   ...
   public PT_EMBLEM decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_EMBLEM var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(PT_EMBLEM var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.index)) {
         Integer var10 = var1.index;
         if (var10 != null) {
   ...
   public void writeTo(PT_EMBLEM var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_EMBLEM readFrom(CodedInputStream var1) throws IOException {
      PT_EMBLEM var2 = new PT_EMBLEM();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_EMBLEM.class);
