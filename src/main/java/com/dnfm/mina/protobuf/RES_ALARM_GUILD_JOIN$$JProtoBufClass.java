...
public class RES_ALARM_GUILD_JOIN$$JProtoBufClass implements Codec<RES_ALARM_GUILD_JOIN>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_ALARM_GUILD_JOIN var1) throws IOException {
   ...
   public RES_ALARM_GUILD_JOIN decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_ALARM_GUILD_JOIN var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(RES_ALARM_GUILD_JOIN var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var7 = var1.error;
         if (var7 != null) {
   ...
   public void writeTo(RES_ALARM_GUILD_JOIN var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_ALARM_GUILD_JOIN readFrom(CodedInputStream var1) throws IOException {
      RES_ALARM_GUILD_JOIN var2 = new RES_ALARM_GUILD_JOIN();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_ALARM_GUILD_JOIN.class);
