...
public class REQ_JOIN_ROOM$$JProtoBufClass implements Codec<REQ_JOIN_ROOM>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(REQ_JOIN_ROOM var1) throws IOException {
   ...
   public REQ_JOIN_ROOM decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(REQ_JOIN_ROOM var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      Object var4 = null;
      if (!CodedConstant.isNull(var1.matetype)) {
         Integer var12 = var1.matetype;
   ...
   public void doWriteTo(REQ_JOIN_ROOM var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.guid)) {
         Long var11 = var1.guid;
         if (var11 != null) {
   ...
   public void writeTo(REQ_JOIN_ROOM var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public REQ_JOIN_ROOM readFrom(CodedInputStream var1) throws IOException {
      REQ_JOIN_ROOM var2 = new REQ_JOIN_ROOM();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               var2.altarindex = var1.readInt32();
            } else {
               var1.skipField(var5);
            }
         }
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(REQ_JOIN_ROOM.class);
