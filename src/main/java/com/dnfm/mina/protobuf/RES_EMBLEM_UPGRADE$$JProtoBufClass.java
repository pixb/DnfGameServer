...
public class RES_EMBLEM_UPGRADE$$JProtoBufClass implements Codec<RES_EMBLEM_UPGRADE>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_EMBLEM_UPGRADE var1) throws IOException {
   ...
   public RES_EMBLEM_UPGRADE decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_EMBLEM_UPGRADE var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.rewards)) {
         PT_CONTENTS_REWARD_INFO var14 = var1.rewards;
   ...
   public void doWriteTo(RES_EMBLEM_UPGRADE var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var9 = var1.error;
         if (var9 != null) {
   ...
   public void writeTo(RES_EMBLEM_UPGRADE var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_EMBLEM_UPGRADE readFrom(CodedInputStream var1) throws IOException {
      RES_EMBLEM_UPGRADE var2 = new RES_EMBLEM_UPGRADE();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_EMBLEM_UPGRADE.class);
