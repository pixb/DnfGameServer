...
public class PT_AUCTION_EQUIP$$JProtoBufClass implements Codec<PT_AUCTION_EQUIP>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_AUCTION_EQUIP var1) throws IOException {
   ...
   public PT_AUCTION_EQUIP decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_AUCTION_EQUIP var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(PT_AUCTION_EQUIP var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.guid)) {
         Long var35 = var1.guid;
         if (var35 != null) {
   ...
   public void writeTo(PT_AUCTION_EQUIP var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_AUCTION_EQUIP readFrom(CodedInputStream var1) throws IOException {
      PT_AUCTION_EQUIP var2 = new PT_AUCTION_EQUIP();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_AUCTION_EQUIP.class);
