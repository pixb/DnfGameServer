...
public class RES_PVP_HISTORY$$JProtoBufClass implements Codec<RES_PVP_HISTORY>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_PVP_HISTORY var1) throws IOException {
   ...
   public RES_PVP_HISTORY decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_PVP_HISTORY var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(RES_PVP_HISTORY var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var13 = var1.error;
         if (var13 != null) {
   ...
   public void writeTo(RES_PVP_HISTORY var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_PVP_HISTORY readFrom(CodedInputStream var1) throws IOException {
      RES_PVP_HISTORY var2 = new RES_PVP_HISTORY();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               var2.mirrorwin = var1.readInt32();
            } else if (var5 == 64) {
               var2.mirrorlose = var1.readInt32();
            } else if (var5 == 72) {
               var2.mirrordraw = var1.readInt32();
            } else if (var5 == 82) {
               Codec var10 = ProtobufProxy.create(PT_PVP_HISTORY_INFO.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               ...
               var2.infos.add((PT_PVP_HISTORY_INFO)var10.readFrom(var1));
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_PVP_HISTORY.class);
