...
public class RES_COMMUNITY_GIFT_RECEIVE$$JProtoBufClass implements Codec<RES_COMMUNITY_GIFT_RECEIVE>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_COMMUNITY_GIFT_RECEIVE var1) throws IOException {
   ...
   public RES_COMMUNITY_GIFT_RECEIVE decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_COMMUNITY_GIFT_RECEIVE var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(RES_COMMUNITY_GIFT_RECEIVE var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var13 = var1.error;
         if (var13 != null) {
   ...
   public void writeTo(RES_COMMUNITY_GIFT_RECEIVE var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_COMMUNITY_GIFT_RECEIVE readFrom(CodedInputStream var1) throws IOException {
      RES_COMMUNITY_GIFT_RECEIVE var2 = new RES_COMMUNITY_GIFT_RECEIVE();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               var2.increasescore = var1.readInt32();
            } else if (var5 == 58) {
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_COMMUNITY_GIFT_RECEIVE.class);
