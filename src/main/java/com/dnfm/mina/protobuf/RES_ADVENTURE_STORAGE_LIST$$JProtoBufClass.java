...
public class RES_ADVENTURE_STORAGE_LIST$$JProtoBufClass implements Codec<RES_ADVENTURE_STORAGE_LIST>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_ADVENTURE_STORAGE_LIST var1) throws IOException {
   ...
   public RES_ADVENTURE_STORAGE_LIST decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_ADVENTURE_STORAGE_LIST var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(RES_ADVENTURE_STORAGE_LIST var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var19 = var1.error;
         if (var19 != null) {
   ...
   public void writeTo(RES_ADVENTURE_STORAGE_LIST var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_ADVENTURE_STORAGE_LIST readFrom(CodedInputStream var1) throws IOException {
      RES_ADVENTURE_STORAGE_LIST var2 = new RES_ADVENTURE_STORAGE_LIST();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_ADVENTURE_STORAGE_LIST.class);
