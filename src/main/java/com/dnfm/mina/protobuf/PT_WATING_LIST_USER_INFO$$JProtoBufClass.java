...
public class PT_WATING_LIST_USER_INFO$$JProtoBufClass implements Codec<PT_WATING_LIST_USER_INFO>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_WATING_LIST_USER_INFO var1) throws IOException {
   ...
   public PT_WATING_LIST_USER_INFO decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_WATING_LIST_USER_INFO var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      if (!CodedConstant.isNull(var1.name)) {
         String var14 = var1.name;
         var2 += CodedOutputStream.computeStringSize(1, var14);
      }

      Object var4 = null;
      if (!CodedConstant.isNull(var1.gname)) {
         String var15 = var1.gname;
   ...
   public void doWriteTo(PT_WATING_LIST_USER_INFO var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.name)) {
         String var14 = var1.name;
         if (var14 != null) {
   ...
   public void writeTo(PT_WATING_LIST_USER_INFO var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_WATING_LIST_USER_INFO readFrom(CodedInputStream var1) throws IOException {
      PT_WATING_LIST_USER_INFO var2 = new PT_WATING_LIST_USER_INFO();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_WATING_LIST_USER_INFO.class);
