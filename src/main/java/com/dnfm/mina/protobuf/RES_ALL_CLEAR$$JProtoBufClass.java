...
public class RES_ALL_CLEAR$$JProtoBufClass implements Codec<RES_ALL_CLEAR>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_ALL_CLEAR var1) throws IOException {
   ...
   public RES_ALL_CLEAR decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_ALL_CLEAR var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      Object var8 = null;
      if (!CodedConstant.isNull(var1.leftsweepcount)) {
         Integer var14 = var1.leftsweepcount;
   ...
   public void doWriteTo(RES_ALL_CLEAR var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var9 = var1.error;
         if (var9 != null) {
   ...
   public void writeTo(RES_ALL_CLEAR var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_ALL_CLEAR readFrom(CodedInputStream var1) throws IOException {
      RES_ALL_CLEAR var2 = new RES_ALL_CLEAR();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               Codec var10 = ProtobufProxy.create(PT_ALL_CLEAR_REWARD.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               ...
               var2.list.add((PT_ALL_CLEAR_REWARD)var10.readFrom(var1));
               ...
               var2.leftsweepcount = var1.readInt32();
            } else {
               var1.skipField(var5);
            }
         }
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_ALL_CLEAR.class);
