...
public class RES_MINIGAME_BREAKING_CLEAR$$JProtoBufClass implements Codec<RES_MINIGAME_BREAKING_CLEAR>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_MINIGAME_BREAKING_CLEAR var1) throws IOException {
   ...
   public RES_MINIGAME_BREAKING_CLEAR decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_MINIGAME_BREAKING_CLEAR var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(RES_MINIGAME_BREAKING_CLEAR var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var11 = var1.error;
         if (var11 != null) {
   ...
   public void writeTo(RES_MINIGAME_BREAKING_CLEAR var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_MINIGAME_BREAKING_CLEAR readFrom(CodedInputStream var1) throws IOException {
      RES_MINIGAME_BREAKING_CLEAR var2 = new RES_MINIGAME_BREAKING_CLEAR();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_MINIGAME_BREAKING_CLEAR.class);
