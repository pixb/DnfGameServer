...
public class PT_GUILD_CHAT$$JProtoBufClass implements Codec<PT_GUILD_CHAT>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_GUILD_CHAT var1) throws IOException {
   ...
   public int size(PT_GUILD_CHAT var1) throws IOException {
      ...
      if (!CodedConstant.isNull(var1.charguid)) {
         Long var49 = var1.charguid;
         var2 += CodedOutputStream.computeUInt64Size(12, var49);
      }

      Object var15 = null;
      if (!CodedConstant.isNull(var1.hyperlinktype)) {
         Integer var50 = var1.hyperlinktype;
         var2 += CodedOutputStream.computeInt32Size(13, var50);
      }

      Object var16 = null;
      if (!CodedConstant.isNull(var1.hyperlinksubtype)) {
         Integer var51 = var1.hyperlinksubtype;
         var2 += CodedOutputStream.computeInt32Size(14, var51);
      }

      Object var17 = null;
      if (!CodedConstant.isNull(var1.hyperlinkdatas)) {
         List var52 = var1.hyperlinkdatas;
         var2 += CodedConstant.computeListSize(15, var52, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var18 = null;
      if (!CodedConstant.isNull(var1.sub)) {
         List var53 = var1.sub;
         var2 += CodedConstant.computeListSize(16, var53, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var19 = null;
      if (!CodedConstant.isNull(var1.equip)) {
         PT_EQUIP var54 = var1.equip;
         var2 += CodedConstant.computeSize(17, var54, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get());
      }

      Object var20 = null;
      if (!CodedConstant.isNull(var1.title)) {
         PT_EQUIP var55 = var1.title;
         var2 += CodedConstant.computeSize(18, var55, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get());
      }

      Object var21 = null;
      if (!CodedConstant.isNull(var1.flag)) {
         PT_EQUIP var56 = var1.flag;
      ...
      if (!CodedConstant.isNull(var1.emblem)) {
         PT_STACKABLE var57 = var1.emblem;
      ...
      if (!CodedConstant.isNull(var1.material)) {
         PT_STACKABLE var58 = var1.material;
      ...
      if (!CodedConstant.isNull(var1.consume)) {
         PT_STACKABLE var59 = var1.consume;
      ...
      if (!CodedConstant.isNull(var1.avatar)) {
         PT_AVATAR_ITEM var60 = var1.avatar;
      ...
      if (!CodedConstant.isNull(var1.creature)) {
         PT_CREATURE var62 = var1.creature;
      ...
      if (!CodedConstant.isNull(var1.cartifact)) {
         PT_ARTIFACT var63 = var1.cartifact;
      ...
      if (!CodedConstant.isNull(var1.skinchatinfo)) {
         PT_SKIN_CHAT_INFO var64 = var1.skinchatinfo;
      ...
      if (!CodedConstant.isNull(var1.sdavatar)) {
         PT_AVATAR_ITEM var65 = var1.sdavatar;
      ...
      if (!CodedConstant.isNull(var1.info)) {
         PT_RECRUIT_PARTY_INFO var66 = var1.info;
      ...
      if (!CodedConstant.isNull(var1.list)) {
         List var67 = var1.list;
         var2 += CodedConstant.computeListSize(30, var67, FieldType.STRING, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var33 = null;
      if (!CodedConstant.isNull(var1.cardindex)) {
         Integer var68 = var1.cardindex;
         var2 += CodedOutputStream.computeInt32Size(31, var68);
      }

      Object var34 = null;
      if (!CodedConstant.isNull(var1.creditscore)) {
         Integer var69 = var1.creditscore;
         var2 += CodedOutputStream.computeInt32Size(32, var69);
      }
   ...
   public void doWriteTo(PT_GUILD_CHAT var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.name)) {
         String var38 = var1.name;
         if (var38 != null) {
            var2.writeString(1, var38);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.hyperlinkdatas)) {
         List var52 = var1.hyperlinkdatas;
         if (var52 != null) {
            CodedConstant.writeToList(var2, 15, FieldType.OBJECT, var52, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.sub)) {
         List var53 = var1.sub;
         if (var53 != null) {
            CodedConstant.writeToList(var2, 16, FieldType.OBJECT, var53, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.equip)) {
         PT_EQUIP var54 = var1.equip;
         if (var54 != null) {
            CodedConstant.writeObject(var2, 17, FieldType.OBJECT, var54, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.title)) {
         PT_EQUIP var55 = var1.title;
         if (var55 != null) {
            CodedConstant.writeObject(var2, 18, FieldType.OBJECT, var55, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.list)) {
         List var67 = var1.list;
         if (var67 != null) {
            CodedConstant.writeToList(var2, 30, FieldType.STRING, var67, false);
         }
      }
   ...
   public void writeTo(PT_GUILD_CHAT var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_GUILD_CHAT readFrom(CodedInputStream var1) throws IOException {
      PT_GUILD_CHAT var2 = new PT_GUILD_CHAT();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_GUILD_CHAT.class);
