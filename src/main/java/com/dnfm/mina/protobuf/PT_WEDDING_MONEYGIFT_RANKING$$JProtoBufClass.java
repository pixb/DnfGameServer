...
public class PT_WEDDING_MONEYGIFT_RANKING$$JProtoBufClass implements Codec<PT_WEDDING_MONEYGIFT_RANKING>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_WEDDING_MONEYGIFT_RANKING var1) throws IOException {
   ...
   public PT_WEDDING_MONEYGIFT_RANKING decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_WEDDING_MONEYGIFT_RANKING var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.rank)) {
         Long var17 = var1.rank;
         var2 += CodedOutputStream.computeInt64Size(7, var17);
      }

      Object var10 = null;
      if (!CodedConstant.isNull(var1.score)) {
         Long var18 = var1.score;
         var2 += CodedOutputStream.computeUInt64Size(8, var18);
      }

      return var2;
   }

   public void doWriteTo(PT_WEDDING_MONEYGIFT_RANKING var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.guid)) {
         Long var11 = var1.guid;
         if (var11 != null) {
      ...
      if (!CodedConstant.isNull(var1.score)) {
         Long var18 = var1.score;
         if (var18 != null) {
            var2.writeUInt64(8, var18);
         }
      }

   }

   public void writeTo(PT_WEDDING_MONEYGIFT_RANKING var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_WEDDING_MONEYGIFT_RANKING readFrom(CodedInputStream var1) throws IOException {
      PT_WEDDING_MONEYGIFT_RANKING var2 = new PT_WEDDING_MONEYGIFT_RANKING();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_WEDDING_MONEYGIFT_RANKING.class);
