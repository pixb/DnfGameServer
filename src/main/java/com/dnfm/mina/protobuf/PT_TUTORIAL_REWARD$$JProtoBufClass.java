...
public class PT_TUTORIAL_REWARD$$JProtoBufClass implements Codec<PT_TUTORIAL_REWARD>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_TUTORIAL_REWARD var1) throws IOException {
   ...
   public PT_TUTORIAL_REWARD decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_TUTORIAL_REWARD var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      if (!CodedConstant.isNull(var1.equipitems)) {
         List var24 = var1.equipitems;
         var2 += CodedConstant.computeListSize(1, var24, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var4 = null;
      if (!CodedConstant.isNull(var1.titleitems)) {
         List var25 = var1.titleitems;
         var2 += CodedConstant.computeListSize(2, var25, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var5 = null;
      if (!CodedConstant.isNull(var1.flagitems)) {
         List var26 = var1.flagitems;
         var2 += CodedConstant.computeListSize(3, var26, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var6 = null;
      if (!CodedConstant.isNull(var1.materialitems)) {
         List var27 = var1.materialitems;
         var2 += CodedConstant.computeListSize(4, var27, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var7 = null;
      if (!CodedConstant.isNull(var1.consumeitems)) {
         List var28 = var1.consumeitems;
         var2 += CodedConstant.computeListSize(5, var28, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var8 = null;
      if (!CodedConstant.isNull(var1.emblemitems)) {
         List var29 = var1.emblemitems;
         var2 += CodedConstant.computeListSize(6, var29, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var9 = null;
      if (!CodedConstant.isNull(var1.carditems)) {
         List var30 = var1.carditems;
         var2 += CodedConstant.computeListSize(7, var30, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var10 = null;
      if (!CodedConstant.isNull(var1.epicpieceitems)) {
         List var31 = var1.epicpieceitems;
      ...
      if (!CodedConstant.isNull(var1.cartifactitems)) {
         List var32 = var1.cartifactitems;
         var2 += CodedConstant.computeListSize(9, var32, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var12 = null;
      if (!CodedConstant.isNull(var1.creatureitems)) {
         List var33 = var1.creatureitems;
         var2 += CodedConstant.computeListSize(10, var33, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var13 = null;
      if (!CodedConstant.isNull(var1.avataritems)) {
         List var34 = var1.avataritems;
         var2 += CodedConstant.computeListSize(11, var34, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var14 = null;
      if (!CodedConstant.isNull(var1.damagefontitems)) {
         List var35 = var1.damagefontitems;
         var2 += CodedConstant.computeListSize(12, var35, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var15 = null;
      if (!CodedConstant.isNull(var1.chatframeitems)) {
         List var36 = var1.chatframeitems;
         var2 += CodedConstant.computeListSize(13, var36, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var16 = null;
      if (!CodedConstant.isNull(var1.characterframeitems)) {
         List var37 = var1.characterframeitems;
         var2 += CodedConstant.computeListSize(14, var37, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var17 = null;
      if (!CodedConstant.isNull(var1.crackitems)) {
         List var38 = var1.crackitems;
         var2 += CodedConstant.computeListSize(15, var38, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var18 = null;
      if (!CodedConstant.isNull(var1.crackequipitems)) {
         List var39 = var1.crackequipitems;
      ...
      if (!CodedConstant.isNull(var1.sdavataritems)) {
         List var40 = var1.sdavataritems;
         var2 += CodedConstant.computeListSize(17, var40, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var20 = null;
      if (!CodedConstant.isNull(var1.bookmarkitems)) {
         List var41 = var1.bookmarkitems;
         var2 += CodedConstant.computeListSize(18, var41, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var21 = null;
      if (!CodedConstant.isNull(var1.scrollitems)) {
         List var42 = var1.scrollitems;
         var2 += CodedConstant.computeListSize(19, var42, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get(), false);
      }

      Object var22 = null;
      if (!CodedConstant.isNull(var1.index)) {
         Integer var43 = var1.index;
         var2 += CodedOutputStream.computeInt32Size(20, var43);
      }

      Object var23 = null;
      if (!CodedConstant.isNull(var1.count)) {
         Integer var44 = var1.count;
   ...
   public void doWriteTo(PT_TUTORIAL_REWARD var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.equipitems)) {
         List var24 = var1.equipitems;
         if (var24 != null) {
            CodedConstant.writeToList(var2, 1, FieldType.OBJECT, var24, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.titleitems)) {
         List var25 = var1.titleitems;
         if (var25 != null) {
            CodedConstant.writeToList(var2, 2, FieldType.OBJECT, var25, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.flagitems)) {
         List var26 = var1.flagitems;
         if (var26 != null) {
            CodedConstant.writeToList(var2, 3, FieldType.OBJECT, var26, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.materialitems)) {
         List var27 = var1.materialitems;
         if (var27 != null) {
            CodedConstant.writeToList(var2, 4, FieldType.OBJECT, var27, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.consumeitems)) {
         List var28 = var1.consumeitems;
         if (var28 != null) {
            CodedConstant.writeToList(var2, 5, FieldType.OBJECT, var28, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.emblemitems)) {
         List var29 = var1.emblemitems;
         if (var29 != null) {
            CodedConstant.writeToList(var2, 6, FieldType.OBJECT, var29, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.carditems)) {
         List var30 = var1.carditems;
         if (var30 != null) {
            CodedConstant.writeToList(var2, 7, FieldType.OBJECT, var30, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.cartifactitems)) {
         List var32 = var1.cartifactitems;
         if (var32 != null) {
            CodedConstant.writeToList(var2, 9, FieldType.OBJECT, var32, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.creatureitems)) {
         List var33 = var1.creatureitems;
         if (var33 != null) {
            CodedConstant.writeToList(var2, 10, FieldType.OBJECT, var33, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.avataritems)) {
         List var34 = var1.avataritems;
         if (var34 != null) {
            CodedConstant.writeToList(var2, 11, FieldType.OBJECT, var34, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.damagefontitems)) {
         List var35 = var1.damagefontitems;
         if (var35 != null) {
            CodedConstant.writeToList(var2, 12, FieldType.OBJECT, var35, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.chatframeitems)) {
         List var36 = var1.chatframeitems;
         if (var36 != null) {
            CodedConstant.writeToList(var2, 13, FieldType.OBJECT, var36, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.characterframeitems)) {
         List var37 = var1.characterframeitems;
         if (var37 != null) {
            CodedConstant.writeToList(var2, 14, FieldType.OBJECT, var37, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.crackitems)) {
         List var38 = var1.crackitems;
         if (var38 != null) {
            CodedConstant.writeToList(var2, 15, FieldType.OBJECT, var38, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.sdavataritems)) {
         List var40 = var1.sdavataritems;
         if (var40 != null) {
            CodedConstant.writeToList(var2, 17, FieldType.OBJECT, var40, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.bookmarkitems)) {
         List var41 = var1.bookmarkitems;
         if (var41 != null) {
            CodedConstant.writeToList(var2, 18, FieldType.OBJECT, var41, false);
         }
      }
      ...
      if (!CodedConstant.isNull(var1.scrollitems)) {
         List var42 = var1.scrollitems;
         if (var42 != null) {
            CodedConstant.writeToList(var2, 19, FieldType.OBJECT, var42, false);
         }
      }
   ...
   public void writeTo(PT_TUTORIAL_REWARD var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_TUTORIAL_REWARD readFrom(CodedInputStream var1) throws IOException {
      PT_TUTORIAL_REWARD var2 = new PT_TUTORIAL_REWARD();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 10) {
               ...
               Codec var27 = ProtobufProxy.create(PT_STACKABLE.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               ...
               var2.bookmarkitems.add((PT_STACKABLE)var27.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var63);
            } else if (var5 == 154) {
               Codec var28 = ProtobufProxy.create(PT_EQUIP.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               ...
               var2.scrollitems.add((PT_EQUIP)var28.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var64);
            } else if (var5 == 160) {
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_TUTORIAL_REWARD.class);
