...
public class DEF_ITEM_CONSUMABLE$$JProtoBufClass implements Codec<DEF_ITEM_CONSUMABLE>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(DEF_ITEM_CONSUMABLE var1) throws IOException {
   ...
   public DEF_ITEM_CONSUMABLE decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(DEF_ITEM_CONSUMABLE var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(DEF_ITEM_CONSUMABLE var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.index)) {
         Integer var11 = var1.index;
         if (var11 != null) {
   ...
   public void writeTo(DEF_ITEM_CONSUMABLE var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public DEF_ITEM_CONSUMABLE readFrom(CodedInputStream var1) throws IOException {
      DEF_ITEM_CONSUMABLE var2 = new DEF_ITEM_CONSUMABLE();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(DEF_ITEM_CONSUMABLE.class);
