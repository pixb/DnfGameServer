...
public class PT_MARRIAGE_CHARACTER_INFO$$JProtoBufClass implements Codec<PT_MARRIAGE_CHARACTER_INFO>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_MARRIAGE_CHARACTER_INFO var1) throws IOException {
   ...
   public PT_MARRIAGE_CHARACTER_INFO decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_MARRIAGE_CHARACTER_INFO var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.secondgrowtype)) {
         Integer var14 = var1.secondgrowtype;
   ...
   public void doWriteTo(PT_MARRIAGE_CHARACTER_INFO var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.guid)) {
         Long var9 = var1.guid;
         if (var9 != null) {
   ...
   public void writeTo(PT_MARRIAGE_CHARACTER_INFO var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_MARRIAGE_CHARACTER_INFO readFrom(CodedInputStream var1) throws IOException {
      PT_MARRIAGE_CHARACTER_INFO var2 = new PT_MARRIAGE_CHARACTER_INFO();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_MARRIAGE_CHARACTER_INFO.class);
