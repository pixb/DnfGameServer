...
public class STREAM_DATA$Types$RES$$JProtoBufClass implements Codec<STREAM_DATA.Types.RES>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(STREAM_DATA.Types.RES var1) throws IOException {
   ...
   public STREAM_DATA.Types.RES decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(STREAM_DATA.Types.RES var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(STREAM_DATA.Types.RES var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var7 = var1.error;
         if (var7 != null) {
   ...
   public void writeTo(STREAM_DATA.Types.RES var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public STREAM_DATA.Types.RES readFrom(CodedInputStream var1) throws IOException {
      STREAM_DATA.Types.RES var2 = new STREAM_DATA.Types.RES();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(STREAM_DATA.Types.RES.class);
