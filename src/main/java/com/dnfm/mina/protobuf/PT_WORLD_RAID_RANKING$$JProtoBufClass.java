...
public class PT_WORLD_RAID_RANKING$$JProtoBufClass implements Codec<PT_WORLD_RAID_RANKING>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_WORLD_RAID_RANKING var1) throws IOException {
   ...
   public PT_WORLD_RAID_RANKING decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_WORLD_RAID_RANKING var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(PT_WORLD_RAID_RANKING var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.growtype)) {
         Integer var12 = var1.growtype;
         if (var12 != null) {
   ...
   public void writeTo(PT_WORLD_RAID_RANKING var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_WORLD_RAID_RANKING readFrom(CodedInputStream var1) throws IOException {
      PT_WORLD_RAID_RANKING var2 = new PT_WORLD_RAID_RANKING();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_WORLD_RAID_RANKING.class);
