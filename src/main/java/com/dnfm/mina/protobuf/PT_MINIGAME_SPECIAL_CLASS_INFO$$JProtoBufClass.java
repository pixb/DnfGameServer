...
public class PT_MINIGAME_SPECIAL_CLASS_INFO$$JProtoBufClass implements Codec<PT_MINIGAME_SPECIAL_CLASS_INFO>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_MINIGAME_SPECIAL_CLASS_INFO var1) throws IOException {
   ...
   public PT_MINIGAME_SPECIAL_CLASS_INFO decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_MINIGAME_SPECIAL_CLASS_INFO var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      if (!CodedConstant.isNull(var1.studentinfo)) {
         PT_MINIGAME_SPECIAL_CLASS_STUDENT_INFO var7 = var1.studentinfo;
   ...
   public void doWriteTo(PT_MINIGAME_SPECIAL_CLASS_INFO var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.studentinfo)) {
         PT_MINIGAME_SPECIAL_CLASS_STUDENT_INFO var7 = var1.studentinfo;
         if (var7 != null) {
   ...
   public void writeTo(PT_MINIGAME_SPECIAL_CLASS_INFO var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_MINIGAME_SPECIAL_CLASS_INFO readFrom(CodedInputStream var1) throws IOException {
      PT_MINIGAME_SPECIAL_CLASS_INFO var2 = new PT_MINIGAME_SPECIAL_CLASS_INFO();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 10) {
               ...
               var2.studentinfo = (PT_MINIGAME_SPECIAL_CLASS_STUDENT_INFO)var10.readFrom(var1);
               ...
               Codec var13 = ProtobufProxy.create(PT_MINIGAME_SPECIAL_CLASS_CLEAR_HISTORY.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               ...
               var2.history.add((PT_MINIGAME_SPECIAL_CLASS_CLEAR_HISTORY)var13.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var19);
            } else {
               var1.skipField(var5);
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_MINIGAME_SPECIAL_CLASS_INFO.class);
