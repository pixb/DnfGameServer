...
public class SESSION_AUTH$RES$$JProtoBufClass implements Codec<SESSION_AUTH.RES>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(SESSION_AUTH.RES var1) throws IOException {
   ...
   public SESSION_AUTH.RES decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(SESSION_AUTH.RES var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(SESSION_AUTH.RES var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var8 = var1.error;
         if (var8 != null) {
   ...
   public void writeTo(SESSION_AUTH.RES var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public SESSION_AUTH.RES readFrom(CodedInputStream var1) throws IOException {
      SESSION_AUTH.RES var2 = new SESSION_AUTH.RES();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(SESSION_AUTH.RES.class);
