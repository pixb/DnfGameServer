...
public class PT_ITEMS_TOWER$$JProtoBufClass implements Codec<PT_ITEMS_TOWER>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_ITEMS_TOWER var1) throws IOException {
   ...
   public PT_ITEMS_TOWER decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_ITEMS_TOWER var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      if (!CodedConstant.isNull(var1.equipitems)) {
         List var17 = var1.equipitems;
      ...
      if (!CodedConstant.isNull(var1.epicpieceitems)) {
         List var24 = var1.epicpieceitems;
      ...
      if (!CodedConstant.isNull(var1.cartifactitems)) {
         List var25 = var1.cartifactitems;
   ...
   public void doWriteTo(PT_ITEMS_TOWER var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.equipitems)) {
         List var17 = var1.equipitems;
         if (var17 != null) {
   ...
   public void writeTo(PT_ITEMS_TOWER var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_ITEMS_TOWER readFrom(CodedInputStream var1) throws IOException {
      PT_ITEMS_TOWER var2 = new PT_ITEMS_TOWER();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_ITEMS_TOWER.class);
