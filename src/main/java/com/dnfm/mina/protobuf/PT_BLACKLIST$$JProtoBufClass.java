...
public class PT_BLACKLIST$$JProtoBufClass implements Codec<PT_BLACKLIST>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_BLACKLIST var1) throws IOException {
   ...
   public PT_BLACKLIST decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_BLACKLIST var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.time)) {
         ...
         var2 += CodedOutputStream.computeInt64Size(3, var13);
      }
   ...
   public void doWriteTo(PT_BLACKLIST var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.charguid)) {
         Long var11 = var1.charguid;
         if (var11 != null) {
   ...
   public void writeTo(PT_BLACKLIST var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_BLACKLIST readFrom(CodedInputStream var1) throws IOException {
      PT_BLACKLIST var2 = new PT_BLACKLIST();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_BLACKLIST.class);
