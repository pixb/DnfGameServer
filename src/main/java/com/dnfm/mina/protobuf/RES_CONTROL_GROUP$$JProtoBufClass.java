...
public class RES_CONTROL_GROUP$$JProtoBufClass implements Codec<RES_CONTROL_GROUP>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_CONTROL_GROUP var1) throws IOException {
   ...
   public RES_CONTROL_GROUP decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_CONTROL_GROUP var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.characterframe)) {
         Integer var86 = var1.characterframe;
         var2 += CodedOutputStream.computeInt32Size(41, var86);
      }

      Object var44 = null;
      if (!CodedConstant.isNull(var1.observer)) {
         Boolean var87 = var1.observer;
         var2 += CodedOutputStream.computeBoolSize(42, var87);
      }

      Object var45 = null;
      if (!CodedConstant.isNull(var1.observerchat)) {
         Boolean var88 = var1.observerchat;
         var2 += CodedOutputStream.computeBoolSize(43, var88);
      }

      return var2;
   }

   public void doWriteTo(RES_CONTROL_GROUP var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var46 = var1.error;
         if (var46 != null) {
      ...
      if (!CodedConstant.isNull(var1.observerchat)) {
         Boolean var88 = var1.observerchat;
         if (var88 != null) {
            var2.writeBool(43, var88);
         }
      }

   }

   public void writeTo(RES_CONTROL_GROUP var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_CONTROL_GROUP readFrom(CodedInputStream var1) throws IOException {
      RES_CONTROL_GROUP var2 = new RES_CONTROL_GROUP();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_CONTROL_GROUP.class);
