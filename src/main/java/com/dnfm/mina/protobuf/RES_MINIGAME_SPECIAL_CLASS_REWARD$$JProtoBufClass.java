...
public class RES_MINIGAME_SPECIAL_CLASS_REWARD$$JProtoBufClass implements Codec<RES_MINIGAME_SPECIAL_CLASS_REWARD>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_MINIGAME_SPECIAL_CLASS_REWARD var1) throws IOException {
   ...
   public RES_MINIGAME_SPECIAL_CLASS_REWARD decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_MINIGAME_SPECIAL_CLASS_REWARD var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(RES_MINIGAME_SPECIAL_CLASS_REWARD var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var7 = var1.error;
         if (var7 != null) {
   ...
   public void writeTo(RES_MINIGAME_SPECIAL_CLASS_REWARD var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_MINIGAME_SPECIAL_CLASS_REWARD readFrom(CodedInputStream var1) throws IOException {
      RES_MINIGAME_SPECIAL_CLASS_REWARD var2 = new RES_MINIGAME_SPECIAL_CLASS_REWARD();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               Codec var11 = ProtobufProxy.create(PT_MINIGAME_SPECIAL_CLASS_CLEAR_HISTORY.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               ...
               var2.history.add((PT_MINIGAME_SPECIAL_CLASS_CLEAR_HISTORY)var11.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var15);
            } else if (var5 == 34) {
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_MINIGAME_SPECIAL_CLASS_REWARD.class);
