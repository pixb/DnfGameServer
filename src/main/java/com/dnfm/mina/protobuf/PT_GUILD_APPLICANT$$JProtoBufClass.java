...
public class PT_GUILD_APPLICANT$$JProtoBufClass implements Codec<PT_GUILD_APPLICANT>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_GUILD_APPLICANT var1) throws IOException {
   ...
   public PT_GUILD_APPLICANT decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_GUILD_APPLICANT var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.creditscore)) {
         Integer var17 = var1.creditscore;
   ...
   public void doWriteTo(PT_GUILD_APPLICANT var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.guid)) {
         Long var11 = var1.guid;
         if (var11 != null) {
   ...
   public void writeTo(PT_GUILD_APPLICANT var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_GUILD_APPLICANT readFrom(CodedInputStream var1) throws IOException {
      PT_GUILD_APPLICANT var2 = new PT_GUILD_APPLICANT();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_GUILD_APPLICANT.class);
