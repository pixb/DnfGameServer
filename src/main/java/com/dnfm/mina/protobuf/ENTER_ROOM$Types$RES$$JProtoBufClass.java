...
public class ENTER_ROOM$Types$RES$$JProtoBufClass implements Codec<ENTER_ROOM.Types.RES>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(ENTER_ROOM.Types.RES var1) throws IOException {
   ...
   public ENTER_ROOM.Types.RES decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(ENTER_ROOM.Types.RES var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(ENTER_ROOM.Types.RES var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var14 = var1.error;
         if (var14 != null) {
   ...
   public void writeTo(ENTER_ROOM.Types.RES var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public ENTER_ROOM.Types.RES readFrom(CodedInputStream var1) throws IOException {
      ENTER_ROOM.Types.RES var2 = new ENTER_ROOM.Types.RES();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(ENTER_ROOM.Types.RES.class);
