...
public class RES_MINIGAME_CLEAR_LOTUS_QUIZ$$JProtoBufClass implements Codec<RES_MINIGAME_CLEAR_LOTUS_QUIZ>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_MINIGAME_CLEAR_LOTUS_QUIZ var1) throws IOException {
   ...
   public RES_MINIGAME_CLEAR_LOTUS_QUIZ decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_MINIGAME_CLEAR_LOTUS_QUIZ var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.attendIndexes)) {
         List var13 = var1.attendIndexes;
         var2 += CodedConstant.computeListSize(5, var13, FieldType.INT32, false, (File)ProtobufProxy.OUTPUT_PATH.get(), true);
      }
   ...
   public void doWriteTo(RES_MINIGAME_CLEAR_LOTUS_QUIZ var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var9 = var1.error;
         if (var9 != null) {
      ...
      if (!CodedConstant.isNull(var1.attendIndexes)) {
         List var13 = var1.attendIndexes;
         if (var13 != null) {
            CodedConstant.writeToList(var2, 5, FieldType.INT32, var13, true);
         }
      }
   ...
   public void writeTo(RES_MINIGAME_CLEAR_LOTUS_QUIZ var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_MINIGAME_CLEAR_LOTUS_QUIZ readFrom(CodedInputStream var1) throws IOException {
      RES_MINIGAME_CLEAR_LOTUS_QUIZ var2 = new RES_MINIGAME_CLEAR_LOTUS_QUIZ();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_MINIGAME_CLEAR_LOTUS_QUIZ.class);
