...
public class RES_ATTACK_SQUAD_MEMBER_VARIANT_NOTI$$JProtoBufClass implements Codec<RES_ATTACK_SQUAD_MEMBER_VARIANT_NOTI>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_ATTACK_SQUAD_MEMBER_VARIANT_NOTI var1) throws IOException {
   ...
   public RES_ATTACK_SQUAD_MEMBER_VARIANT_NOTI decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_ATTACK_SQUAD_MEMBER_VARIANT_NOTI var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.user)) {
         PT_GROUP_MEMBER var11 = var1.user;
   ...
   public void doWriteTo(RES_ATTACK_SQUAD_MEMBER_VARIANT_NOTI var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var9 = var1.error;
         if (var9 != null) {
   ...
   public void writeTo(RES_ATTACK_SQUAD_MEMBER_VARIANT_NOTI var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_ATTACK_SQUAD_MEMBER_VARIANT_NOTI readFrom(CodedInputStream var1) throws IOException {
      RES_ATTACK_SQUAD_MEMBER_VARIANT_NOTI var2 = new RES_ATTACK_SQUAD_MEMBER_VARIANT_NOTI();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_ATTACK_SQUAD_MEMBER_VARIANT_NOTI.class);
