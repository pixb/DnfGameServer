...
public class RES_COMPOSE_SCROLL$$JProtoBufClass implements Codec<RES_COMPOSE_SCROLL>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_COMPOSE_SCROLL var1) throws IOException {
   ...
   public RES_COMPOSE_SCROLL decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_COMPOSE_SCROLL var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      Object var4 = null;
      if (!CodedConstant.isNull(var1.scrolls)) {
         List var9 = var1.scrolls;
      ...
      Object var7 = null;
      if (!CodedConstant.isNull(var1.scrollcomposedailycount)) {
         Integer var12 = var1.scrollcomposedailycount;
   ...
   public void doWriteTo(RES_COMPOSE_SCROLL var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var8 = var1.error;
         if (var8 != null) {
   ...
   public void writeTo(RES_COMPOSE_SCROLL var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_COMPOSE_SCROLL readFrom(CodedInputStream var1) throws IOException {
      RES_COMPOSE_SCROLL var2 = new RES_COMPOSE_SCROLL();
      var2.scrolls = new ArrayList();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               if (var2.scrolls == null) {
                  var2.scrolls = new ArrayList();
               }

               var2.scrolls.add((PT_ITEM_GUID)var10.readFrom(var1));
               ...
               var2.scrollcomposedailycount = var1.readInt32();
            } else {
               var1.skipField(var5);
            }
         }
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_COMPOSE_SCROLL.class);
