...
public class RES_ITEM_AVATAR_COMPOSE$$JProtoBufClass implements Codec<RES_ITEM_AVATAR_COMPOSE>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_ITEM_AVATAR_COMPOSE var1) throws IOException {
   ...
   public RES_ITEM_AVATAR_COMPOSE decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_ITEM_AVATAR_COMPOSE var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.rewards)) {
         PT_CONTENTS_REWARD_INFO var11 = var1.rewards;
         var2 += CodedConstant.computeSize(4, var11, FieldType.OBJECT, false, (File)ProtobufProxy.OUTPUT_PATH.get());
      }

      Object var7 = null;
      if (!CodedConstant.isNull(var1.avatarcompounddailycount)) {
         Integer var12 = var1.avatarcompounddailycount;
   ...
   public void doWriteTo(RES_ITEM_AVATAR_COMPOSE var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var8 = var1.error;
         if (var8 != null) {
   ...
   public void writeTo(RES_ITEM_AVATAR_COMPOSE var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_ITEM_AVATAR_COMPOSE readFrom(CodedInputStream var1) throws IOException {
      RES_ITEM_AVATAR_COMPOSE var2 = new RES_ITEM_AVATAR_COMPOSE();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               var2.avatarcompounddailycount = var1.readInt32();
            } else {
               var1.skipField(var5);
            }
         }
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_ITEM_AVATAR_COMPOSE.class);
