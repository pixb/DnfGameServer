...
public class RES_CARD_ATTACH$$JProtoBufClass implements Codec<RES_CARD_ATTACH>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_CARD_ATTACH var1) throws IOException {
   ...
   public RES_CARD_ATTACH decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_CARD_ATTACH var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.card)) {
         PT_CARD_ATTACH var11 = var1.card;
   ...
   public void doWriteTo(RES_CARD_ATTACH var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var8 = var1.error;
         if (var8 != null) {
   ...
   public void writeTo(RES_CARD_ATTACH var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_CARD_ATTACH readFrom(CodedInputStream var1) throws IOException {
      RES_CARD_ATTACH var2 = new RES_CARD_ATTACH();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               Codec var10 = ProtobufProxy.create(PT_CARD_ATTACH.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               int var6 = var1.readRawVarint32();
               int var7 = var1.pushLimit(var6);
               var2.card = (PT_CARD_ATTACH)var10.readFrom(var1);
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_CARD_ATTACH.class);
