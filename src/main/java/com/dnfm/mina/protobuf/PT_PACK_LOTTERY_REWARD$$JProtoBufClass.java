...
public class PT_PACK_LOTTERY_REWARD$$JProtoBufClass implements Codec<PT_PACK_LOTTERY_REWARD>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_PACK_LOTTERY_REWARD var1) throws IOException {
   ...
   public PT_PACK_LOTTERY_REWARD decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_PACK_LOTTERY_REWARD var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.crackequipitems)) {
         List var33 = var1.crackequipitems;
      ...
      if (!CodedConstant.isNull(var1.accountcurrency)) {
         List var38 = var1.accountcurrency;
   ...
   public void doWriteTo(PT_PACK_LOTTERY_REWARD var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.equipitems)) {
         List var21 = var1.equipitems;
         if (var21 != null) {
   ...
   public void writeTo(PT_PACK_LOTTERY_REWARD var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_PACK_LOTTERY_REWARD readFrom(CodedInputStream var1) throws IOException {
      PT_PACK_LOTTERY_REWARD var2 = new PT_PACK_LOTTERY_REWARD();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 10) {
               ...
               int var41 = var1.pushLimit(var26);
               ...
               int var42 = var1.pushLimit(var27);
               ...
               int var43 = var1.pushLimit(var28);
               ...
               int var44 = var1.pushLimit(var29);
               ...
               int var45 = var1.pushLimit(var30);
               ...
               int var46 = var1.pushLimit(var31);
               ...
               int var47 = var1.pushLimit(var32);
               ...
               int var48 = var1.pushLimit(var33);
               ...
               int var49 = var1.pushLimit(var34);
               ...
               int var50 = var1.pushLimit(var35);
               ...
               int var51 = var1.pushLimit(var36);
               ...
               int var52 = var1.pushLimit(var37);
               ...
               int var53 = var1.pushLimit(var38);
               ...
               int var54 = var1.pushLimit(var39);
               ...
               Codec var25 = ProtobufProxy.create(PT_MONEY_ITEM.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               int var40 = var1.readRawVarint32();
               int var55 = var1.pushLimit(var40);
               if (var2.accountcurrency == null) {
                  var2.accountcurrency = new ArrayList();
               }

               var2.accountcurrency.add((PT_MONEY_ITEM)var25.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var55);
            } else {
               var1.skipField(var5);
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_PACK_LOTTERY_REWARD.class);
