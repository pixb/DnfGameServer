...
public class NOTIFY_REQUEST_TO_RE_ENTER_DUNGEON$$JProtoBufClass implements Codec<NOTIFY_REQUEST_TO_RE_ENTER_DUNGEON>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(NOTIFY_REQUEST_TO_RE_ENTER_DUNGEON var1) throws IOException {
   ...
   public NOTIFY_REQUEST_TO_RE_ENTER_DUNGEON decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(NOTIFY_REQUEST_TO_RE_ENTER_DUNGEON var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(NOTIFY_REQUEST_TO_RE_ENTER_DUNGEON var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var10 = var1.error;
         if (var10 != null) {
   ...
   public void writeTo(NOTIFY_REQUEST_TO_RE_ENTER_DUNGEON var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public NOTIFY_REQUEST_TO_RE_ENTER_DUNGEON readFrom(CodedInputStream var1) throws IOException {
      NOTIFY_REQUEST_TO_RE_ENTER_DUNGEON var2 = new NOTIFY_REQUEST_TO_RE_ENTER_DUNGEON();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(NOTIFY_REQUEST_TO_RE_ENTER_DUNGEON.class);
