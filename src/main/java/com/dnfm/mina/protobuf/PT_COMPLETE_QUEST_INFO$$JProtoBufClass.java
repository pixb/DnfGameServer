...
public class PT_COMPLETE_QUEST_INFO$$JProtoBufClass implements Codec<PT_COMPLETE_QUEST_INFO>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(PT_COMPLETE_QUEST_INFO var1) throws IOException {
   ...
   public PT_COMPLETE_QUEST_INFO decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(PT_COMPLETE_QUEST_INFO var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
   ...
   public void doWriteTo(PT_COMPLETE_QUEST_INFO var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.index)) {
         Integer var8 = var1.index;
         if (var8 != null) {
   ...
   public void writeTo(PT_COMPLETE_QUEST_INFO var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public PT_COMPLETE_QUEST_INFO readFrom(CodedInputStream var1) throws IOException {
      PT_COMPLETE_QUEST_INFO var2 = new PT_COMPLETE_QUEST_INFO();
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(PT_COMPLETE_QUEST_INFO.class);
