...
public class RES_MONEY_ITEM_LIST$$JProtoBufClass implements Codec<RES_MONEY_ITEM_LIST>, Serializable {
   public static final long serialVersionUID = 1L;
   private Descriptors.Descriptor descriptor;

   public byte[] encode(RES_MONEY_ITEM_LIST var1) throws IOException {
   ...
   public RES_MONEY_ITEM_LIST decode(byte[] var1) throws IOException {
      CodedInputStream var2 = CodedInputStream.newInstance(var1, 0, var1.length);
      return this.readFrom(var2);
   }

   public int size(RES_MONEY_ITEM_LIST var1) throws IOException {
      int var2 = 0;
      Object var3 = null;
      ...
      if (!CodedConstant.isNull(var1.characterdailygain)) {
         List var11 = var1.characterdailygain;
      ...
      if (!CodedConstant.isNull(var1.accountdailygain)) {
         List var12 = var1.accountdailygain;
   ...
   public void doWriteTo(RES_MONEY_ITEM_LIST var1, CodedOutputStream var2) throws IOException {
      Object var3 = null;
      if (!CodedConstant.isNull(var1.error)) {
         Integer var8 = var1.error;
         if (var8 != null) {
   ...
   public void writeTo(RES_MONEY_ITEM_LIST var1, CodedOutputStream var2) throws IOException {
      this.doWriteTo(var1, var2);
   }

   public RES_MONEY_ITEM_LIST readFrom(CodedInputStream var1) throws IOException {
      RES_MONEY_ITEM_LIST var2 = new RES_MONEY_ITEM_LIST();
      ...
      try {
         ...
         while(!var3) {
            ...
            if (var5 == 8) {
               ...
               Codec var12 = ProtobufProxy.create(PT_CURRENCY_DAILY_GAIN.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               ...
               var2.characterdailygain.add((PT_CURRENCY_DAILY_GAIN)var12.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var18);
            } else if (var5 == 42) {
               Codec var13 = ProtobufProxy.create(PT_CURRENCY_DAILY_GAIN.class, false, (File)ProtobufProxy.OUTPUT_PATH.get());
               ...
               var2.accountdailygain.add((PT_CURRENCY_DAILY_GAIN)var13.readFrom(var1));
               var1.checkLastTagWas(0);
               var1.popLimit(var19);
            } else {
               var1.skipField(var5);
   ...
   public Descriptors.Descriptor getDescriptor() throws IOException {
      if (this.descriptor != null) {
         ...
         Descriptors.Descriptor var1 = CodedConstant.getDescriptor(RES_MONEY_ITEM_LIST.class);
