-- 2026-09-08 第八十轮: 分解随机池/权重产物
-- t_make_disjoint 加 result_pool 列(JSON: [{"material_index","material_count","bind_type","weight"}])
ALTER TABLE t_make_disjoint ADD COLUMN result_pool TEXT NULL;

-- 新模板 3004 精铁盾牌(分解随机池测试源)
...
-- 3004 分解随机池: 60% 破损剑刃x2 / 40% 破损护甲x1
